...
export default function Room01_Lab() {
  ...
  const processRealFile = async (selectedFile: File) => {
    ...
    try {
      ...
      // FIXED: Removed the auto-advancing setTimeout so you can actually read the results!
  ...
  const handlePurchasedBeatDSP = async (beatUrl: string, beatName: string) => {
    ...
    try {
      ...
      // FIXED: Removed the auto-advancing setTimeout here too!
  ...
  // FIXED: Restored your exact hardcoded premium beats
    ...
    <div className="h-full flex flex-col lg:flex-row gap-8 animate-in fade-in duration-500">
      ...
      <div className="flex-1 flex flex-col">
        ...
        >
          ...
          {/* FIXED: Restored the beautiful detailed results screen */}
