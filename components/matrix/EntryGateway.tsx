  ...
  if (authStep === "landing") {
    return (
      <div className="min-h-screen bg- text- selection:bg- selection:text-white relative overflow-x-hidden font-sans">
        ...
        {/* SYSTEM BANNER */}
        <div className="w-full bg- text-white py-2 text-center font-mono text- uppercase tracking- font-bold z-50 relative">
          <span className="inline-block w-2 h-2 bg-white rounded-full animate-pulse mr-2 mb-"></span>
