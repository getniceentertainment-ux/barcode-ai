...
export default function Room03_Ghostwriter() {
  ...
  const styles = [
    { id: "getnice_hybrid", name: "GetNice Flow" },
    { id: "user_flow", name: "User Flow" },
    { id: "melodic_trap", name: "Melodic Trap" },
    { id: "triplet", name: "Triplet (Fast)" },
    { id: "rnb", name: "R&B Vocalist" }
  ];
    ...
    <div className="h-full flex flex-col md:flex-row bg-[#050505] animate-in fade-in duration-500 border border-[#222]">
      ...
      <div className="w-full md:w-5/12 lg:w-1/3 border-r border-[#222] flex flex-col relative h-full bg-black z-10">
        ...
        <div className="p-6 border-t border-[#222] bg-[#020202]">
          {status === "idle" && (
            <button onClick={handleGenerate} disabled={!gwPrompt.trim()} className="w-full bg-[#E60000] text-white py-4 font-oswald text-lg font-bold uppercase tracking-[0.2em] hover:bg-red-700 transition-all disabled:opacity-30 flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(230,0,0,0.2)]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        ...
        {/* RESTORED: THE BLUEPRINT BLOCK BUILDER */}
