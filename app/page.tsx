...
import { 
  ...
  Send, Wallet, Radio, Users, ShieldAlert, LogOut, Zap, Loader2, Lock, Play, Pause, SkipBack, SkipForward, Volume2
} from "lucide-react";
      ...
      <main className="flex-1 relative flex flex-col bg-black overflow-hidden">
        ...
        <div className="h-14 border-b border-[#111] bg-black/80 backdrop-blur-md flex items-center justify-between px-6 lg:px-10 z-10 shrink-0">
           ...
           <div className="flex items-center gap-4 sm:gap-6 ml-auto">
             ...
             {/* Mobile Disconnect Button (Visible only on small screens) */}
             <button onClick={handleDisconnect} className="md:hidden text-[#555] hover:text-[#E60000] ml-2">
               <LogOut size={14} />
             </button>
